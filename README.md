...
* **spiderfy**(keepPositions): Spiderfies the child markers of this cluster. If optional argument `keepPositions` is true, markers will appear at their original position.
